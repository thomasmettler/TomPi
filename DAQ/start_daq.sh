...
sleep 1
#cd /home/pi/Tom_Stuff/MQ_sensors/Raspberry-Pi-Gas-Sensor-MQ
screen -d -m -S DAQ bash -c 'python /home/pi/Tom_Stuff/MQ_sensors/Raspberry-Pi-Gas-Sensor-MQ/MQ_DAQ.py'
sleep 1
screen -d -m -S temp bash -c 'python /home/pi/Tom_Stuff/TEMP_DAQ.py'
sleep 1
